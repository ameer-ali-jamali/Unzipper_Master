    ...
    <body>
        ...
        ?>
            <form action="" method="POST">
                ...
                <input type="text" id="zip-file-name" name="zip_file_name" value=""
                    placeholder="Name of the zip file" />
                <p><strong>Select Items</strong></p>
                <p><input type="checkbox" id="select-all-files" value="Select All"><label for="select-all-files"
                        class="fs-label">Select All</label></p>
                <?php
        ...
        <div class="copyright">Copyright &copy; <?php echo date("Y"); ?> . All rights Reserved by <a
                href="https://abdulawal.com/" target="_blank">Abdul Awal Uzzal</a></div>
